...
class JarFileEntries implements CentralDirectoryVisitor, Iterable<JarEntry>
{
    ...
    private <T extends FileHeader> T getEntry(final CharSequence name, final Class<T> type, final boolean cacheEntry) {
        ...
        T entry = this.getEntry(hashCode, name, '\0', type, cacheEntry);
        if (entry == null) {
    ...
    private <T extends FileHeader> T getEntry(final int hashCode, final CharSequence name, final char suffix, final Class<T> type, final boolean cacheEntry) {
